::To be used before running scripts that need to access devices connected to the Interconnect module.
::Interconnect module connects to the arm through Ethernet
::Sets a route to the device's subnetwork through the arm's IP address.
